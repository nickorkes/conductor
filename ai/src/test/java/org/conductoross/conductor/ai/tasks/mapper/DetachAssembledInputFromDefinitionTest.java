...
/**
 * Tests for {@link AIModelTaskMapper#detachAssembledInputFromDefinition(TaskModel, String...)}.
 *
 ...
 */
class DetachAssembledInputFromDefinitionTest {
    ...
    void detachReplacesDefinitionWithTaskOwnedCopyLackingAssembledKeys() {
        ...
        mapper.detachAssembledInputFromDefinition(task, "messages", "tools");
    ...
    void noOpWhenDefinitionDoesNotDeclareAssembledKeys() {
        ...
        // No collision -> no clone needed; the shared instance is kept as-is.
        assertThat(task.getWorkflowTask()).isSameAs(sharedDef);
    }
    ...
    void nullDefinitionAndNullParametersAreTolerated() {
        ...
        mapper.detachAssembledInputFromDefinition(task, "messages");
