...
public class AgentChatCompleteTaskMapper extends AIModelTaskMapper<ChatCompletion> {
    ...
    private void snapshotMessagesOntoTaskDefinition(TaskModel taskModel) {
        WorkflowTask sharedDefinition = taskModel.getWorkflowTask();
        if (sharedDefinition == null) {
            return;
        }
        Object assembledMessages = taskModel.getInputData().get("messages");
        ...
        try {
            ...
            inputParameters.put("messages", assembledMessages);
